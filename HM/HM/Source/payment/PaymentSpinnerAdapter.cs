...
namespace HM
{
    public class PaymentSpinnerAdapter : BaseAdapter<string>
    {
        private List<Payment> mCategories;
        private Context mContext;

        public PaymentSpinnerAdapter(List<Payment> categories, Context context)
        {
