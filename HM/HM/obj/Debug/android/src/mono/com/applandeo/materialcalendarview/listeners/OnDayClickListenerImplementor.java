...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Applandeo.Materialcalendarview.Listeners.IOnDayClickListenerImplementor, Material-Calendar-View-for-Xamarin", OnDayClickListenerImplementor.class, __md_methods);
	}
	...
	public OnDayClickListenerImplementor ()
	{
		...
		if (getClass () == OnDayClickListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Applandeo.Materialcalendarview.Listeners.IOnDayClickListenerImplementor, Material-Calendar-View-for-Xamarin", "", this, new java.lang.Object[] {  });
	}
