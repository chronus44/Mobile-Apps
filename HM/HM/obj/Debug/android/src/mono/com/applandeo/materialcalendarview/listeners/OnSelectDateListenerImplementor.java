...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Applandeo.Materialcalendarview.Listeners.IOnSelectDateListenerImplementor, Material-Calendar-View-for-Xamarin", OnSelectDateListenerImplementor.class, __md_methods);
	}
	...
	public OnSelectDateListenerImplementor ()
	{
		...
		if (getClass () == OnSelectDateListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Applandeo.Materialcalendarview.Listeners.IOnSelectDateListenerImplementor, Material-Calendar-View-for-Xamarin", "", this, new java.lang.Object[] {  });
	}
