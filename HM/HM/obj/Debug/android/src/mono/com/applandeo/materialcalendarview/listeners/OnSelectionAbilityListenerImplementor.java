...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Applandeo.Materialcalendarview.Listeners.IOnSelectionAbilityListenerImplementor, Material-Calendar-View-for-Xamarin", OnSelectionAbilityListenerImplementor.class, __md_methods);
	}
	...
	public OnSelectionAbilityListenerImplementor ()
	{
		...
		if (getClass () == OnSelectionAbilityListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Applandeo.Materialcalendarview.Listeners.IOnSelectionAbilityListenerImplementor, Material-Calendar-View-for-Xamarin", "", this, new java.lang.Object[] {  });
	}
