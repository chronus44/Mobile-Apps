...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HM.Source.payment.PaymentAdapter, HM", PaymentAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == PaymentAdapter.class)
			mono.android.TypeManager.Activate ("HM.Source.payment.PaymentAdapter, HM", "", this, new java.lang.Object[] {  });
	}
